...
public class SwitchStatements3_6 {
    public static void main(String[] args) {
        ...
        switch (weather){
            case "sunny": System.out.println("It is sunny.");break;
            case "cloudy": System.out.println("It is cloudy.");break;
            case "rainy": System.out.println("It is rainy.");break;
            default: System.out.println("It is snowy.");
        }
        ...
        if(age == 25 & income >= 50000){
            System.out.println("Yay, eligible");
        }else{
