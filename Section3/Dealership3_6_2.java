        ...
        switch (option){
            case "a": System.out.println("you chose option " + option);
                        ...
                        if (budget >= 10000){
                            ...
                            if (insurance.equals("yes") && license.equals("yes") && creditScore > 660){
                                ...
                                System.out.println("We're sorry. You are not eligible");break;
                            }
            ...
            case "b": System.out.println("you chose option " + option);
                ...
                if ((value > price) && price < 30000){
                    System.out.println("We will buy your car. Pleasure doing business with you!");break;
                }else{
